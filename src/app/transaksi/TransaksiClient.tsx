...
function CurrencyInput({
  ...
  return (
    <div className="relative flex items-center w-full">
      {prefix && (
        <span className="absolute left-3 text-xs font-semibold text-slate-400 dark:text-zinc-500 pointer-events-none select-none">
          {prefix}
        </span>
      )}
      <input
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-3">
                  {selectedItems.map((item, index) => (
                    <div
                      key={index}
                      className="grid grid-cols-12 gap-2 bg-slate-50 dark:bg-zinc-950/60 p-3 rounded-2xl border border-slate-200 dark:border-zinc-800 items-center text-xs"
                    >
                      <div className="col-span-12 sm:col-span-6">
                        <label className="block text-[10px] font-semibold text-slate-500 dark:text-zinc-400 mb-1">
                          Pilih / Cari Item ({index + 1})
                        </label>
                      ...
                      <div className="col-span-4 sm:col-span-2">
                        ...
                        <input
                          ...
                          className="w-full bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 rounded-xl px-2.5 py-2 text-slate-900 dark:text-zinc-100 outline-none text-center font-mono text-xs shadow-sm"
                          placeholder="1"
                        />
                      </div>
                      ...
                      <div className="col-span-2 sm:col-span-1 flex justify-end pt-4">
                        {selectedItems.length > 1 && (
                          <button
                            ...
                            className="w-7 h-7 rounded-lg bg-rose-50 dark:bg-rose-950/40 text-rose-600 dark:text-rose-400 hover:bg-rose-100 flex items-center justify-center cursor-pointer font-bold transition"
